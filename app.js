...
app.post('/login', function(req, res, next){
    ...
    // $.ajax({
    //     url:`http://badgeserver.ece.cornell.edu:8080/login?email=${email}&passwd=${passwd}`,
    //     type: 'POST',
    ...
    var url = `http://badgeserver.ece.cornell.edu:8080/user/login?email=${email}&passwd=${passwd}`;
...
app.listen(port, () => {
  console.log(`Example app listening at http://badgeserver.ece.cornell.edu:${port}`)
})
